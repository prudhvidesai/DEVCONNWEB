        ...
        <div className="card bg-black w-96 shadow-xl">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-start">
              <button className="btn btn-primary" onClick={()=>handleSendRequest(_id,"Ignore")}>Ignored</button>
              <button className="btn btn-secondary" onClick={()=>handleSendRequest(_id,"Interested")}>Interested</button>
            </div>
          </div>
        </div>
      </div>
